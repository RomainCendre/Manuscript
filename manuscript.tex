...
\declarethesis[]{Aide au diagnostic du lentigo malin en dermatologie par analyse d’images multimodales}{Date de soutenance}{Dijon}{XXX}
...
\part{Contexte}
\label{part:contexte}
\include{contents/ii_preamble_context/content}
...
\include{contents/iii_preamble_microscopy/content}
...
\include{contents/iv_preamble_multimodal/content}
\include{contents/chapter_7/content}

% Conclusion
\include{contents/v_conclusion/content}
\include{contents/vi_valorisation/content}

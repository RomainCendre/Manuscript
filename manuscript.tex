...
Ces travaux s'inscrivent dans la continuité d'outils d'aide au diagnostic de la peau par ordinateur, dont le but est d'apporter de nouveau éléments de réponse utiles à la prise de décision du spécialiste. La finalité de ces travaux est de proposer des méthodes d'aide à la prise de décision exploitant les trois modalités majeures de la dermatologie afin d'améliorer la prise en charge clinique des patients. A la manière d'un processus clinique, ces modalités sont exploités de la moins coûteuse d'entre elle à la plus coûteuse soit respectivement, la photographie clinique puis la dermatoscopie et enfin la microscopie par réflectance.
}

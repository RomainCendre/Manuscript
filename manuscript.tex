...
\thesiskeywords[english]{Dermatology, Lentigo Maligna, Lentigo Maligna Melanoma, Machine Learning, Deep Learning, Image classification, Multimodality, Data fusion, Dermoscopy, Reflectance Confocal Microscopy}

%%-------------------- 
%% Set the French abstract
\thesisabstract[french]{
Réalisé en collaboration avec le CHU de Saint-Étienne, ce travail s'inscrit dans la continuité d'outils d'aide au diagnostic de la peau par l'apport de nouvelles méthodes de prise de décision sur les pathologies de Lentigo Maligna et de Lentigo Maligna Melanoma. À cette fin, les modalités couramment employées en milieu clinique sont mises à disposition de ce travail et sont orchestrée au sein d'un processus de prise en charge multimodal. Parmi ces modalités mises à disposition peuvent être cités la photographie clinique, la dermatoscopie et la microscopie confocale par réflectance.\par

Dans un premier temps, ce travail se focalise sur la microscopie confocale par réflectance dont les travaux d'aide au diagnostic par ordinateur sont relativement peu développés, notamment sur la détection des pathologies de Lentigo Maligna et de Lentigo Maligna Melanoma. A cet effet, plusieurs méthodes d'apprentissage automatique sont présentées pour permettre la séparation de cette modalité au niveau des données images selon les annotations saines, bénignes et malignes. Puis, les méthodes les plus pertinentes au niveau image sont combinées à des méthodes de prédiction supervisées et faiblement supervisées pour permettre une prise de décision au niveau des lésions.\par

Dans un second temps, le processus multimodal proposé reprend la cheminement clinique, en  débutant par la modalité la plus abordable et accessible, soit respectivement la photographie clinique, la dermatoscopie et enfin la microscopie confocal par réflectance. Selon ce principe, deux schémas sont proposées dans ce manuscrit l'un considéré comme sans mémoire, c'est à dire ne requérant que les données mise à disposition par la modalité courante, et l'autre avec mémoire, c'est à dire par accumulation de l'information acquise préalablement.\par
}

%%--------------------
%% Set the French keywords. They only appear if
%% there is an French abstract
\thesiskeywords[french]{Dermatologie, Lentigo Maligna, Lentigo Maligna Melanoma, Apprentissage automatique, Apprentissage profond, Classification d'images, Multimodalité, Fusion de données, Dermatoscopie, Microscopie confocale par réflectance}

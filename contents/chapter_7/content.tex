...
\begin{figure}[H]
    ...
    \caption{Courbes \gls{roc} issues de la prédiction au niveau des instances sur l'ensemble des cas, figurant à l'aide d'un trait orange estompé tracé en continu, et sur les cas de \gls{lm} / \gls{lmm}, figurant à l'aide d'un trait orange tracé en pointillés. Les courbes sont issues  du mode de prédiction faiblement supervisée sur la base de la théorie \gls{mil} par utilisation du modèle \gls{misvm}.}

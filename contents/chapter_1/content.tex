...
Cette barrière se décompose en diverses couches fondamentales, représentées sur la \Cref{fig:illustration_skin_kholoski}, dont~:~l’\textbf{épiderme}, la \textbf{jonction dermo-épidermique}, le \textbf{derme} et l’\textbf{hypoderme}.\par
\begin{figure}[H]
    \centering
...
La seconde catégorie est composée des mélanomes nodulaires, dont l'évolution plus rapide est liée à un développent vertical dès les premiers symptômes. L'indice de Clark est également employé dans le but de caractériser les stades de ce type de mélanome~\cite{Clark1969}, représenté sur la \Cref{fig:illustration_clarklevels_kholoski}.\par
...
Le \gls{lm} résulte d'une prolifération de cellules malignes mélanocytaires au sein de la couche basale de l'épiderme. Son développement progressif est constitué de plusieurs étapes successives, dont~:

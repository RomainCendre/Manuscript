...
\section{Discussion}
Différentes propositions de méthodes ont été réalisées dans ce chapitre dédié à la prise en charge de lésions de la peau par multimodalité. Lors de la \Cref{sec:modality_diagnosis} consacrée aux méthodes de diagnostic des modalités, le choix s'est porté sur un processus uniforme à l'ensemble des modalités mises à disposition pour ce travail. Pour rappel, sur l’ensemble des lésions de l'étude de Cinotti~\al{Cinotti2016}, les experts obtiennent~: 
\begin{inlinerate}

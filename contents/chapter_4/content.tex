...
La séparation des diverses données ne semble pas optimum comme nous pouvons le constater sur \Cref{fig:visualisation_spatial}. En effet, les centroids et leur dispersion semble assez similaire, notemment pour les données bénines et malignes.\par

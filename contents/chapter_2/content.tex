...
Microscope confocale                                                                  & Réflectance              & \si{\micro\metre}            & \textless{} \SI{200}{\micro\metre}    \\
\begin{tabular}[c]{@{}l@{}}Tomographie en cohérence\\   optique\end{tabular}          & Réflectance              & \si{\micro\metre}            & \SIrange{1}{2}{\milli\metre}          \\
Imagerie spectrale                                                                    & Réflectance              & Lentille dépendant           & \SIrange{0.1}{1}{\milli\metre}       \\
\begin{tabular}[c]{@{}l@{}}Spectroscopie à réflexion\\   diffuse\end{tabular}         & Réflectance              & Diamètre de la fibre         & \SIrange{0.1}{1}{\milli\metre}        \\
Spectroscopie de fluorescence                                                         & Fluorescence             & Diamètre de la fibre         & \SIrange{0.1}{1}{\milli\metre}        \\
...
\end{tabular}
\caption{Aperçu des divers type d’imageurs utilisés en dermatologie \cite{Kollias2002}.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{contents/chapter_2/resources/.pdf}
...
Afin d'évaluer les performances de praticiens face à ces lésions, les investigateurs ont recouru à 21 dermatologues expert des modalités d'imagerie non invasives. \Cref{fig:experts_evaluation} 
\begin{figure}[H]
    \centering
